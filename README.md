...
| **PyTeal / TEAL Contract Scaffold** | 🟡 **Scaffolded** | AVM approval program assembly (`contracts/sentinelpay.py`) |
| **GoPlausible Facilitator & Live TestNet** | 🔵 **Planned** | Live TestNet atomic group broadcasting with GoPlausible facilitator |
